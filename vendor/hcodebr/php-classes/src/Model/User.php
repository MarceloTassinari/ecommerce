...
class User extends Model {
	...
	public static function listAll()
	{
		...
		/**
		 * será feito uma mescla da tabela usuários (a) com a tabela pessoas (b), buscando dados de uma e de outra, ordenando por pessoas da tabela b.
		 **/
	...
	public static function getForgot($email, $inadmin = true)
	{
		...
		else
		{
			...
			else
			{
				...
				/**
				 * base64: transformando em base 64
	...
	public static function setFogotUsed($idrecovery)
	{
		...
		//
		$sql->runquery("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = :idrecovery", array(
			":idrecovery"=>$idrecovery
		));
	...
	public function setPassword($password)
	{
		...
		$sql->runquery("UPDATE tb_users SET despassword = :password WHERE iduser = :iduser", array(
			":password"=>$password,
			":iduser"=>$this->getiduser()
		));
